  ...
  useEffect(() => {
    ...
    if (cleaned.length > 0 && cleaned.length < 16) {
      ...
      if (cleaned.length === 16) {
        detectedType = getCardType(cleaned);
      }
      setCardValidation({
        valid: false,
        message: "۱۶ رقم",
      ...
      if (editingSection === "account") {
        ...
        const updateData = {
          payment: {
            ...
            accountIdentifier:
              toEnglishDigits(sanitizedData.accountNumber) || null,
          },
        };
                ...
                <div className={styles.twoCols}>
                  ...
                  <div>
                    <input
                      ...
                      onChange={(e) =>
                        handleEnglishInput(e, "nationalId", setValue)
                      }
                    />
                    {errors.nationalId && (
                      <span className={styles.errorText}>
                ...
                <div className={styles.twoCols}>
                  ...
                  <div>
                    <input
                      ...
                      onChange={(e) =>
                        handleEnglishInput(e, "birthDate", setValue)
                      }
                    />
                    {errors.birthDate && (
                      <span className={styles.errorText}>
            ...
            {editingSection === "bank" ? (
              <div className={styles.formGroup}>
                  ...
                  <div className={styles.bankFieldHeader}>
                    {cardValidation.cardType && (
                      <span className={styles.bankNameLabel}>
                        بانک {cardValidation.cardType.name}
                      </span>
                    )}
                  </div>
                ...
                <div className={styles.bankFieldWrapper}>
                  ...
                  <div className={styles.bankInputWrapper}>
                    <input
                      ...
                      onChange={(e) =>
                        handleEnglishInput(e, "accountNumber", setValue)
                      }
                    />
                    <ValidationBadge
                ...
                <div className={styles.validationGuide}>
                  <p>💡 نکات مهم:</p>
                  <ul>
                    <li style={{ color: "red", fontSize: "17px" }}>
                      اعداد باید به لاتین وارد شوند . 0 - 9
                    </li>
                    <li>
