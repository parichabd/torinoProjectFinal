...
import Cookies from "js-cookie"; // ✅ این خط رو اضافه کن
...
export const profileApi = {
  getProfile: async () => {
    ...
    console.log("📥 GET Profile Response:", response.data); // ← اضافه کن
    return response.data;
  },
  updateProfile: async (data) => {
    console.log("📤 UPDATE Profile Data:", data); // ← اضافه کن
    const response = await api.put("/user/profile", data);
    console.log("📥 UPDATE Response:", response.data); // ← اضافه کن
    return response.data;
  },
};
export default api;